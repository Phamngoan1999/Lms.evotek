...
public class NewCustomerPageObject extends AbstractPage{
	...
	public DepositPageObject clickToDepositPageObject () {
		waitToElementVisible(driver, MainPageUI.LINK_DEPOSIT_CUSTOMER);
		clickToElement(driver, MainPageUI.LINK_DEPOSIT_CUSTOMER);
